...
const AboutUsScreen = () => {
  ...
  return (
    <CommonHeader title={'關於我們'}>
      <ScrollView>
        <CacheImage
          source={ImageProvider.heroImageAboutUs}
          style={[tailwind('w-full'), {aspectRatio: 414 / 580}]}
        />
        <View style={tailwind('py-8 px-4')}>
          <Text
            ...
            FUNWOO
            為房產科技公司，旨於透過科技解決房產問問題，簡化房產交易流程，
            成就你的理想生活。
          </Text>
          ...
          <Text
            ...
            NETFLIX 最後市佔勝過 BLOCKBUSTER， AMAZON 取代
            SEARS，美國科技房產公司 COMPASS
            短短幾年成為龍頭，藉由科技提供服務已是世界潮流趨勢。APP
            ...
            {'\n'}
            {'\n'}
            「第一印象的建立，在於初次見面的7秒鐘。」 FUNWOO
            還會以過去台灣少見的 OPEN HOUSE
            模式，並為現場進行最適合的擺設佈置，讓買家一開門就能發出 WOW~
            的驚嘆聲，
