        ...
        <Tab.Navigator screenOptions={({ route }) => ({
            ...
            tabBarIcon: ({ size, focused }) => {
                ...
                switch (route.name) {
                    ...
                    case PageNames.search:
                        return <CustomTabIcon name={`search-${state}`} size={size} color={color} />;
                    case PageNames.fav:
                        return <CustomTabIcon name={`fav-${state}`} size={size} color={color} />;
                    case PageNames.sell:
                        return <CustomTabIcon name={`sell-${state}`} size={size} color={color} />;
                    case PageNames.more:
                        return <CustomTabIcon name={`more-${state}`} size={size} color={color} />;
                    default:
                        break;
                }
            },
            ...
            <Tab.Screen name={PageNames.home} options={{
                title: "首頁",
                headerShown: false
            }} component={HomeScreen} />
            <Tab.Screen name={PageNames.search} options={{
                title: "買屋",
                headerShown: false
            }} component={HomeScreen} />
            <Tab.Screen name={PageNames.fav} options={{
                title: "我的收藏",
                headerShown: false
            }} component={HomeScreen} />
            <Tab.Screen name={PageNames.sell} options={{
                title: "賣屋",
                headerShown: false
            }} component={HomeScreen} />
